 ...
 * Kuumba C++ Core
 *
 * $Id: xform.cpp 15199 2007-03-09 17:57:17Z tvk $
 */
#include <inc/core/Core.h>
#include <inc/xml/IXMLTransform.h>

#define KCC_FILE    "xform"
#define KCC_VERSION "$Id: xform.cpp 15199 2007-03-09 17:57:17Z tvk $"

// main: entry point into xslt transformation console application
int main(int argc, const char* argv[])
{
    std::cout <<
        "xform - Kuumba Code Generation" << std::endl << std::endl;
