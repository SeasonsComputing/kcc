...
////////////////////////////////////////////////////////
 ...
 #define _THROWS ,_jpr_Throws*/
  ...
  class CLuceneError
  {
	...
	TCHAR* _twhat;
  public:
    CLuceneError(const CLuceneError& clone); //todo: write assignment operator too???
 ...
 #define _CLFINALLY(x) catch(...){ x; throw; } x //note, doesn't code in x if a normal return occurs
