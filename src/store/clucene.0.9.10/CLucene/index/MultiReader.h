...
CL_NS_DEF(index)
   ...
   *
   * @version $Id: MultiReader.h 15199 2007-03-09 17:57:17Z tvk $
   */
  ...
  /** As yet unoptimized implementation. */
	...
	public:
		...
		MultiReader(CL_NS(store)::Directory* directory, SegmentInfos* sis, bool closeDirectory, IndexReader** subReaders);
