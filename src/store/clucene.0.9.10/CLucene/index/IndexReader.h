...
#include "Terms.h"
//todo: normalise capitalisation on functions 
...
/** IndexReader is an abstract class, providing an interface for accessing an
 ...
 @version $Id: IndexReader.h 15199 2007-03-09 17:57:17Z tvk $
*/
	...
	private:
        ...
        DEFINE_MUTEX(lockSetNorm);
        DEFINE_MUTEX(Delete_LOCK);
        DEFINE_MUTEX(commitLock);
        DEFINE_MUTEX(lockUndeleteAll);
	...
	public:
      ...
      */
      virtual void norms(const TCHAR* field, uint8_t* bytes, const int32_t offset) = 0;
        ...
        */
		static int64_t lastModified(const char* directory);
      ...
      * */
		static int64_t lastModified(const CL_NS(store)::Directory* directory);
    ...
    //is available.		
	  ...
	  protected:
		...
		public:
			...
			//Constructor	
			IndexReaderLockWith(CL_NS(store)::LuceneLock* lock, CL_NS(store)::Directory* dir, const bool closeDir);
